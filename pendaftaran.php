...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-3xl shadow-xl max-w-4xl w-full flex flex-col md:flex-row overflow-hidden min-h-[580px]">
        ...
        <div class="w-full md:w-[40%] bg-gradient-to-b from-[#1e61d4] via-[#2563eb] to-[#f59e0b] p-6 md:p-8 flex flex-col justify-between relative text-white">
            ...
            <div class="flex items-center gap-3 z-10">
                <img src="path-ke-logo-anda/logo.png" alt="Logo Klinik BTH" class="h-9 w-auto object-contain" onerror="this.onerror=null; this.src='https://placehold.co/150x40/ffffff/1e61d4?text=LOGO+KLINIK';">
            </div>

            <div class="my-8 md:my-0 z-10">
                <h1 class="text-2xl md:text-3xl font-bold tracking-wide mb-3">Buat Akun<br>Baru</h1>
                <p class="text-white/90 text-xs leading-relaxed max-w-sm">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-xl p-3.5 text-slate-800 flex items-start gap-3 shadow-md z-10 max-w-sm">
                <div class="bg-blue-100 p-2 rounded-lg text-blue-600 flex items-center justify-center shrink-0">
                    <i class="fa-solid fa-clipboard-list text-lg"></i>
                </div>
                <div>
                    <h4 class="font-bold text-xs text-blue-900 mb-0.5">Pendaftaran Online</h4>
                    <p class="text-[11px] text-slate-600 leading-normal">Daftar berobat lebih cepat dan mudah tanpa antre panjang.</p>
                </div>
            </div>

            <div class="absolute bottom-4 left-6 opacity-20 grid grid-cols-4 gap-2 pointer-events-none">
                <div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div>
                <div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div><div class="w-1 h-1 bg-white rounded-full"></div>
            </div>
        </div>

        <div class="w-full md:w-[60%] p-6 md:p-8 flex flex-col justify-center bg-white relative">
            
            <div class="mb-4">
                <h2 class="text-xl font-bold text-blue-950 mb-0.5">Daftar Akun</h2>
                <p class="text-xs text-slate-500">Silakan isi data diri Anda dengan benar.</p>
            </div>

            <form action="simpan_pendaftaran.php" method="POST" class="space-y-3">
    ...
    <div class="pt-1">
        ...
        <button 
            type="submit" 
            class="w-full bg-[#22c55e] hover:bg-[#16a34a] text-white text-xs font-medium py-2.5 rounded-xl shadow-md shadow-green-600/10 transition-all duration-200 active:scale-[0.99]">
